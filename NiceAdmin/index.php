      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="logout.php" name="sigout">
          ...
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <script>
                    ...
                    // Make an AJAX request to your PHP script to fetch data
                    fetch('bar-graph.php')
                      ...
                      .then(data => {
                        ...
                        const counts = data.map(item => item.total_activities);
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">List of Users</span></h5>
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <script>
                    document.addEventListener("DOMContentLoaded", () => {
                      // Step 7: Make an AJAX request to fetch gender data from your PHP script
                      fetch('piechart-connect.php')
                        .then(response => response.json())
                        .then(genderData => {
                          // Step 8: Log the received data for debugging
                          console.log('Gender Data:', genderData);

                          // Step 9: Initialize the pie chart
                          new Chart(document.querySelector('#pieChart'), {
                            ...
                            data: {
                              ...
                              datasets: [{
                                ...
                                data: [genderData['Male'], genderData['Female'], genderData['Prefer not to say']],
                                backgroundColor: [
                                  'rgb(0, 123, 255)', // Male
                                  'rgb(255, 99, 132)', // Female
                                  'rgb(255, 205, 86)'  // Prefer not to say
                                ],
                                hoverOffset: 4
                              }]
                            }
